...
public class AspectJAdvice {
    ...
    @ Pointcut("execution(* com.zhou.essearch.service.impl.ServiceAspectDemoImpl.getCustomerById(..))")
    private void aspectJMethod(){};

    @ Pointcut("execution(* com.zhou.essearch.service.impl.ServiceAspectDemoImpl.deleteCustomer(..))")
    private void aspectJMethodDel(){};
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable{
        ...
        if(!"admin".equals(name)){
            //核心逻辑
            System.out.println("匹配失败，不往下执行");
            return "error";
        }
        Object retval=pjp.proceed();
        System.out.println("此处可做一些类似after的工作:"+name);
